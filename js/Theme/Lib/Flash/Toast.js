...
export const toast = (() => {
     ...
     */
    function toast(text, options, transitions = null) {
     ...
     * @param {Object} options The style to set for the Toast
     */
    function generateToast(text, options) {
        let style = options.style.main
        let classes = (options.classes || []).join(' ')
        ...
        //toastStage.className = 'shadow-lg shadow-cyan-500/50';
    }
